...
Public Class addCandidateChange
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            sqlcommand.CommandText = "DELETE FROM information WHERE candidate_id='" & Label2.Text & "'"
            sqlcommand.ExecuteNonQuery()
            cnn.Close()

            cnn.Close()
            cnn.Open()
            Dim cmd As New OleDbCommand("INSERT INTO Information VALUES(@name,@photo,'" & Label2.Text & "')", cnn)
    ...
    Private Sub addCandidateChange_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
