...
Public Class sampletabulate_others
    ...
    Private Sub sampletabulate_others_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            For i = 0 To dtt.Rows.Count - 1
                'dtt.Rows(i)
                prodo2 = dtt.Rows(i)("group_number")
                candidateList.Items.Add(prodo2)
                prodo3 = dtt.Rows(i)("group_name")
            ...
            Else
                ...
                Else
                    ...
                    Else
                        ...
                        sqlcommand.CommandText = "UPDATE judgescoreboard_others SET score='" & Label4.Text & "' WHERE candidate_name='" & canName.Text & "' And category_id='" & ComboBox1.Text & "' And judge_name='" & Label1.Text & "'"
                        sqlcommand.ExecuteNonQuery()
                        cnn.Close()

                        cnn.Open()
                        Dim daa As New OleDb.OleDbDataAdapter("Select candidate_id,candidate_name,score from judgescoreboard_others Where category_id='" & ComboBox1.Text & "' and judge_name='" & Label1.Text & "'", cnn)
                        Dim dtt As New DataTable
                        'fill data to datatable
                        daa.Fill(dtt)
    ...
    Private Sub DataGridView1_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellEnter
        ...
        Try
            ...
            cnn.Open()
            sqlcommand.Connection = cnn
            sqlcommand.CommandText = "SELECT photo FROM Information_others WHERE candidate_id='" & canNamex.Text & "'"
    ...
    Private Sub ComboBox2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox2.SelectedIndexChanged
        ...
        cnn.Open()
        Dim daa As New OleDb.OleDbDataAdapter("SELECT * FROM category_others where category_name='" & ComboBox2.Text & "'", cnn)
        Dim dtt As New DataTable
        'fill data to datatable
        daa.Fill(dtt)
        For i = 0 To dtt.Rows.Count - 1
        ...
        Else
            ...
            cnn.Open()
            Dim daa1 As New OleDb.OleDbDataAdapter("SELECT criteria_others.criteria_name,criteria_others.max_points,criteria_others.score FROM category_others INNER JOIN criteria_others ON category_others.category_id=criteria_others.category_id WHERE category_others.category_id='" & ComboBox1.Text & "'", cnn)
            Dim dtt1 As New DataTable
            'fill data to datatable
            daa1.Fill(dtt1)
            ...
            cnn.Open()
            Dim daa2 As New OleDb.OleDbDataAdapter("SELECT * FROM category_others WHERE category_id='" & ComboBox1.Text & "'", cnn)
            ...
            Else
                ...
                cnn.Open()
                Dim daa3 As New OleDb.OleDbDataAdapter("SELECT * FROM criteria_others WHERE category_id='" & ComboBox1.Text & "'", cnn)
                ...
                cnn.Open()
                Dim daa4 As New OleDb.OleDbDataAdapter("SELECT * FROM judgescoreboard_others WHERE category_id='" & ComboBox1.Text & "' and judge_name='" & Label1.Text & "'", cnn)
                ...
                Else
                    ...
                    For listA As Integer = 0 To candidateList.Items.Count - 1
                        cnn.Open()
                        sqlcommand.Connection = cnn
                        sqlcommand.CommandText = "INSERT INTO judgescoreboard_others VALUES('" & ComboBox1.Text & "','" & candidateList.Items.Item(listA) & "','" & candidateListName.Items.Item(listA) & "','" & Label1.Text & "',0)"
                        sqlcommand.ExecuteNonQuery()
                        cnn.Close()
                    Next
                End If
                ...
                cnn.Open()
                Dim daa5 As New OleDb.OleDbDataAdapter("Select candidate_id,candidate_name,score from judgescoreboard_others WHERE category_id='" & ComboBox1.Text & "' and  judge_name='" & Label1.Text & "'", cnn)
    ...
    Private Sub canNamex_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles canNamex.Click
    ...
    Private Sub judName_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles judName.Click
    ...
    Private Sub grTab_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles grTab.Enter
    ...
    Private Sub canName_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles canName.Click

    End Sub

    Private Sub txCatidKo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txCatidKo.Click
    ...
    Private Sub candidateListName_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles candidateListName.SelectedIndexChanged

    End Sub

    Private Sub candidateList_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles candidateList.SelectedIndexChanged

    End Sub

    Private Sub lblSelectedcat_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblSelectedcat.Click
    ...
    Private Sub btnSelectCat_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelectCat.Click
