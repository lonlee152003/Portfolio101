...
Public Class sampleSMSApp_others
    ...
    Private Sub frmMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            cnn.Open()
            Dim daa As New OleDb.OleDbDataAdapter("Select candidate_no,keyword from keyword_sms_others", cnn)
        ...
        Try
            ...
            If time = 1 Then
                ...
                Else
                    ...
                    cnn.Open()
                    Dim daa As New OleDb.OleDbDataAdapter("SELECT cellphone_no FROM receiver_sms_others WHERE cellphone_no= '" & agrew & "' ", cnn)
                    Dim dtt As New DataTable
                    'fill data to datatable
                    daa.Fill(dtt)
                    ...
                    Else
                        ...
                        cnn.Open()
                        Dim daa1 As New OleDb.OleDbDataAdapter("SELECT keyword,score FROM keyword_sms_others WHERE keyword= '" & agrew2 & "' ", cnn)
                        ...
                        If lblMess.Text = agrew2 Then
                            ...
                            sqlcommand.CommandText = "INSERT INTO  receiver_sms_others VALUES('" & agrew & "','" & agrew2 & "','" & agrew1 & "')"
                            ...
                            cnn.Open()
                            sqlcommand.Connection = cnn
                            sqlcommand.CommandText = "UPDATE keyword_sms_others SET score='" & scoor & "' WHERE keyword='" & agrew2 & "'"
                            sqlcommand.ExecuteNonQuery()
                            cnn.Close()
                            scoor = 0
                        End If
    ...
    Private Sub btnAddCateg_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddCateg.Click
        Try
            ...
            cnn.Open()
            Dim daa As New OleDb.OleDbDataAdapter("SELECT keyword FROM keyword_sms_others", cnn)
            Dim dtt As New DataTable
            'fill data to datatable
            daa.Fill(dtt)
            For i = 0 To dtt.Rows.Count - 1
            ...
            For countKo As Integer = 0 To lsKeywordko.Items.Count - 1
                cnn.Open()
                Dim daa1 As New OleDb.OleDbDataAdapter("SELECT category_name,category_id FROM category_others where category_name='SMS Poll'", cnn)
                Dim dtt1 As New DataTable
                'fill data to datatable
                daa1.Fill(dtt1)
                For i1 = 0 To dtt1.Rows.Count - 1
            ...
            If lblSmsPollExist.Text = "SMS Poll" Then
                ...
                cnn.Open()
                Dim daa2 As New OleDb.OleDbDataAdapter("SELECT score FROM keyword_sms_others", cnn)
                Dim dtt2 As New DataTable
                'fill data to datatable
                daa2.Fill(dtt2)
                For i2 = 0 To dtt2.Rows.Count - 1
                    'candiNo = dtt2.Rows(i2)("username")
                ...
                cnn.Open()
                Dim daa3 As New OleDb.OleDbDataAdapter("SELECT group_name,group_number FROM candidate_others", cnn)
                Dim dtt3 As New DataTable
                'fill data to datatable
                daa3.Fill(dtt3)
                For i3 = 0 To dtt3.Rows.Count - 1
                    'candiNo = dtt3.Rows(i3)("username")
                    lsCandidatePay.Items.Add(dtt3.Rows(i3)("group_name"))
                    lsCandino.Items.Add(dtt3.Rows(i3)("group_number"))
                Next
                cnn.Close()
                ...
                For lsCand As Integer = 0 To lsCandidatePay.Items.Count() - 1
                    ...
                    cnn.Open()
                    Dim daa4 As New OleDb.OleDbDataAdapter("SELECT candidate_others.group_number,candidate_others.group_name,keyword_sms_others.score FROM candidate_others LEFT JOIN keyword_sms_others ON candidate_others.group_number=keyword_sms_others.candidate_no WHERE candidate_others.group_number='" & lsCandino.Items.Item(lsCand) & "'", cnn)
                    Dim dtt4 As New DataTable
                    'fill data to datatable
                    daa4.Fill(dtt4)
                    For i4 = 0 To dtt4.Rows.Count - 1
                        'candiNo = dtt4.Rows(i4)("username")
                        lblCandidatoMet.Text = dtt4.Rows(i4)("group_name")
                        lblScoremet.Text = dtt4.Rows(i4)("score")
                        lblCandidatono.Text = dtt4.Rows(i4)("group_number")
                    Next
                    cnn.Close()
                    ...
                    cnn.Open()
                    Dim daa5 As New OleDb.OleDbDataAdapter("SELECT category_id, candidate_name FROM judgescoreboard_others where candidate_name='" & lblCandidatoMet.Text & "' and category_id='" & lblCatid.Text & "'", cnn)
                    ...
                    If lblExiscandidata.Text = lsCandidatePay.Items.Item(lsCand) And lblExisCatid.Text = lblCatid.Text Then
                        ...
                        cnn.Open()
                        sqlcommand.Connection = cnn
                        sqlcommand.CommandText = "UPDATE judgescoreboard_others SET score='" & percentScore & "' WHERE category_id='" & lblCatid.Text & "' And candidate_name='" & lblCandidatoMet.Text & "'"
                        sqlcommand.ExecuteNonQuery()
                        cnn.Close()
                        MsgBox("existing")
                    Else
                        ...
                        cnn.Open()
                        sqlcommand.Connection = cnn
                        sqlcommand.CommandText = "INSERT INTO  judgescoreboard_others VALUES('" & lblCatid.Text & "','" & lblCandidatono.Text & "','" & lblCandidatoMet.Text & "','SMSPOLLX','" & percentScore & "')"
                        sqlcommand.ExecuteNonQuery()
                        cnn.Close()
                        MsgBox("not existing")
                    End If
        ...
        Try
            ...
            Else
                If MsgBox("ARE YOU SURE YOU WANT TO INSERT " & txKeyword.Text & "", MsgBoxStyle.OkCancel, "Confirmation") = MsgBoxResult.Ok Then
                    ...
                    'get the value of category id
                    cnn.Open()
                    Dim daa As New OleDb.OleDbDataAdapter("SELECT * FROM keyword_sms_others WHERE candidate_no='" & txcatkey.Text & "'", cnn)
                    Dim dtt As New DataTable
                    'fill data to datatable
                    daa.Fill(dtt)
                    For i = 0 To dtt.Rows.Count - 1
                        'dtt.Rows(i)
                        catidxx = dtt.Rows(i)("candidate_no")
                    ...
                    Else
                        ...
                        cnn.Open()
                        Dim daa1 As New OleDb.OleDbDataAdapter("SELECT * FROM keyword_sms_others WHERE keyword='" & txKeyword.Text & "'", cnn)
                        Dim dtt1 As New DataTable
                        'fill data to datatable
                        daa1.Fill(dtt1)
                        For i1 = 0 To dtt1.Rows.Count - 1
                        ...
                        Else
                            ...
                            cnn.Open()
                            sqlcommand.Connection = cnn
                            sqlcommand.CommandText = "INSERT INTO keyword_sms_others VALUES('" & txcatkey.Text & "','" & txKeyword.Text & "',0)"
                            sqlcommand.ExecuteNonQuery()
                            cnn.Close()
                            MsgBox("KEYWORDS SUCCESSFULLY ADDED TO THE DATABASE", vbInformation, "Success")

                            cnn.Open()
                            Dim daa2 As New OleDb.OleDbDataAdapter("Select candidate_no,keyword from keyword_sms_others", cnn)
                            Dim dtt2 As New DataTable
                            'fill data to datatable
                            daa2.Fill(dtt2)
    ...
    Private Sub btneditkey_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btneditkey.Click
        Try
            If MsgBox("Are you sure you want to edit the keyword of " & txCandidato.Text & " into " & txKeyword.Text & "", MsgBoxStyle.YesNo, "Confirmation") = MsgBoxResult.Yes Then
                cnn.Open()
                sqlcommand.Connection = cnn
                sqlcommand.CommandText = "UPDATE keyword_sms_others SET keyword='" & txKeyword.Text & "' WHERE candidate_no='" & txcatkey.Text & "'"
                sqlcommand.ExecuteNonQuery()
                cnn.Close()
        ...
        Try
            ...
            For i = 0 To dtt.Rows.Count - 1
                ...
                If prodo = txCandidato.Text Then
                    txcatkey.Text = dtt.Rows(i)("group_number")
                    Label27.Text = dtt.Rows(i)("group_number")
                End If
            Next
            cnn.Close()
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Dim view As New viewSMSReport_others
        view.ShowDialog()
    End Sub
